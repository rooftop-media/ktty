...
all the <a href="https://github.com/rooftop-media/ktty/tree/main/graphics">Graphics Functions</a> ( 🗂 `/ktty/graphics/*`) and also
all the <a href="https://github.com/rooftop-media/ktty/tree/main/browser">Browser Functions ( 🗂 `/ktty/browser/*` ). 
